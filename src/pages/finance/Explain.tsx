...
const EXPLAIN: Record<string, { title: string; intro: string; sections: Section[] }> = {
  ...
  people: {
    title: 'People',
    intro: 'Everyone who works here or owns part of the company, and everything about them in one place.',
    sections: [
      { q: 'Give access',
        a: 'Approves an email so that person can sign in and see the finance pages. Founder sees everything. Director sees everything except other people’s salaries, and can sign off your milestones. Stakeholder sees only their own.' },
      { q: 'Does this let them into the rest of the admin app?',
        a: 'No. This is finance access only. Gists, users and moderation are a separate list under Account Permissions.' },
      { q: 'Salary',
        a: '"Flat" means the same amount every month, no conditions. "Officer" and "Founder" use the contract bands on the Payroll tab, where pay rises and falls with gross profit.' },
      { q: 'Contracts',
        a: 'Upload their signed employment contract. It is stored privately — links expire after five minutes, and only you and that person can open theirs.' },
      { q: 'Rewards',
        a: 'One-off bonuses or share awards, separate from salary. A share award also updates the ownership register automatically.' },
      { q: 'Somebody with 0 shares',
        a: 'Staff who do not own part of the company. Normal — they simply do not show on the Ownership tab.' },
    ],
  },
