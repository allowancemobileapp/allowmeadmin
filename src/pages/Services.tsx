    ...
    <div className="space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Services</h2>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {services.length === 0 && <p className="py-10 text-center text-slate-500 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 border-dashed">No services found.</p>}
              ...
              <div key={service.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-1">{service.description || "No description provided."}</p>
