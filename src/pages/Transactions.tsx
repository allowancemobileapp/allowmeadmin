            ...
            <tbody className="divide-y divide-slate-100">
              {filteredTransactions.map((tx: any) => (
                <tr key={tx.id} className="hover:bg-slate-50/50">
                  ...
                  <td className="px-6 py-4 text-emerald-600 font-mono font-bold text-base">+₦{(parseFloat(tx.amount) / 100).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}</td>
